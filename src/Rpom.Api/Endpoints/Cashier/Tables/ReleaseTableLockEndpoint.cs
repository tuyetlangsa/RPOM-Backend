...
internal sealed class ReleaseTableLockEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/cashier/tables/{tableId:int}/lock",
                ...
                {
                    Result result = await sender.Send(new ReleaseTableLock.Command(tableId), ct);
            ...
            .WithDescription(
                "Request: route tableId (int). No-op if absent or held by another staff. Response: 204 No Content.");
    }
}
