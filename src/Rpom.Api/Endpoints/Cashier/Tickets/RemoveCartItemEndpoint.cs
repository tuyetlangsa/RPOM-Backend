...
internal sealed class RemoveCartItemEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapDelete("api/cashier/tickets/{ticketId:long}/cart-items/{cartItemId:long}",
            ...
            {
                var result = await sender.Send(new RemoveCartItem.Command(ticketId, cartItemId), ct);
            ...
            .WithDescription("Request: route ticketId (long) + cartItemId (long). Detail rows cascade. Response: 204 No Content.");
    }
}
