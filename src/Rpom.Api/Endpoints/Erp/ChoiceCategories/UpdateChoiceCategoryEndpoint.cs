...
internal sealed class UpdateChoiceCategoryEndpoint : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPut("api/choice-categories/{id:int}",
            ...
            {
                var result = await sender.Send(new UpdateChoiceCategory.Command(
            ...
            .Produces<ApiResult<UpdateChoiceCategory.Response>>(StatusCodes.Status200OK)
            .ProducesProblem(StatusCodes.Status400BadRequest)
            .ProducesProblem(StatusCodes.Status404NotFound)
            .ProducesProblem(StatusCodes.Status409Conflict)
            .WithSummary("Update a choice category.")
            .WithDescription("Request: route id (int); JSON body { name:string, note?:string, minChoice:short, maxChoice?:short, displayOrder:short, isActive:bool }. Response: 200 OK — JSON UpdateChoiceCategory.Response.");
    }
