...
namespace Rpom.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260630154444_AddKitchenOrderPin")]
    partial class AddKitchenOrderPin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rpom.Domain.Access.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Rpom.Domain.Access.Page", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ModuleId")
                        .HasDatabaseName("ix_pages_module_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Access.StaffAccountPageAccess", b =>
                {
                    ...
                    b.HasKey("StaffAccountId", "PageId")
                        .HasName("pk_staff_account_page_accesses");

                    b.HasIndex("PageId")
                        .HasDatabaseName("ix_staff_account_page_access_page_id");

                    b.ToTable("staff_account_page_accesses", "public");
                });
            ...
            modelBuilder.Entity("Rpom.Domain.Operations.KitchenOrderPin", b =>
                {
                    b.Property<int>("KitchenStationId")
                        .HasColumnType("integer")
                        .HasColumnName("kitchen_station_id");
                    ...
                    b.Property<int>("PinnedByStaffId")
                        .HasColumnType("integer")
                        .HasColumnName("pinned_by_staff_id");

                    b.HasKey("KitchenStationId", "OrderId")
                        .HasName("pk_kitchen_order_pins");

                    b.HasIndex("KitchenStationId")
                        .HasDatabaseName("ix_kitchen_order_pin_station");

                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_kitchen_order_pins_order_id");

                    b.ToTable("kitchen_order_pins", "public");
                });
            ...
            modelBuilder.Entity("Rpom.Domain.Sales.CashDrawer.CashDrawerSession", b =>
                {
                    ...
                    b.HasIndex("ShiftId")
                        .HasDatabaseName("ix_cash_drawer_sessions_shift_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Sales.TicketPaymentDetail", b =>
                {
                    ...
                    b.Property<long?>("ParentPaymentDetailId")
                        .HasColumnType("bigint")
                        .HasColumnName("parent_payment_detail_id");
                    ...
                    b.HasIndex("ParentPaymentDetailId")
                        .HasDatabaseName("ix_ticket_payment_details_parent_payment_detail_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Access.Page", b =>
                {
                    b.HasOne("Rpom.Domain.Access.Module", "Module")
                        .WithMany("Pages")
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pages_modules_module_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Access.StaffAccountPageAccess", b =>
                {
                    b.HasOne("Rpom.Domain.Access.Page", "Page")
                        .WithMany("StaffAccountPageAccesses")
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_staff_account_page_accesses_pages_page_id");
                    ...
                    b.HasOne("Rpom.Domain.Access.StaffAccount", "StaffAccount")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_staff_account_page_accesses_staff_accounts_staff_account_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Operations.KitchenOrderPin", b =>
                {
                    b.HasOne("Rpom.Domain.Operations.KitchenStation", "KitchenStation")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_kitchen_order_pins_kitchen_stations_kitchen_station_id");
                    ...
                    b.HasOne("Rpom.Domain.Sales.Order", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_kitchen_order_pins_orders_order_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Sales.CashDrawer.CashDrawerSession", b =>
                {
                    ...
                    b.HasOne("Rpom.Domain.Operations.Shift", "Shift")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_cash_drawer_sessions_shifts_shift_id");
            ...
            modelBuilder.Entity("Rpom.Domain.Sales.TicketPaymentDetail", b =>
                {
                    b.HasOne("Rpom.Domain.Sales.TicketPaymentDetail", "ParentPaymentDetail")
                        .WithMany("ChildPaymentDetails")
                        .HasForeignKey("ParentPaymentDetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_ticket_payment_details_ticket_payment_details_parent_paymen");
                    ...
                    b.Navigation("ParentPaymentDetail");
            ...
            modelBuilder.Entity("Rpom.Domain.Access.Page", b =>
                {
                    b.Navigation("StaffAccountPageAccesses");
                });
            ...
            modelBuilder.Entity("Rpom.Domain.Sales.TicketPaymentDetail", b =>
                {
                    b.Navigation("ChildPaymentDetails");
                });
